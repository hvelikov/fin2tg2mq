...
public class JmsPutGet {
	...
	private static final String HOST = "192.168.22.12"; // Host name or IP address
	...
	public static void main(String[] args) {
		...
		try {
			...
			cf.setStringProperty(WMQConstants.WMQ_APPLICATIONNAME, "maintest.JmsPutGet (JMS)");
			...
			cf.setIntProperty(WMQConstants.WMQ_CONNECTION_MODE, WMQConstants.WMQ_CM_CLIENT);  //  WMQConstants.WMQ_CM_BINDINGS
